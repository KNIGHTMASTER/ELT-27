 ...
 * @author fauzi
 */
public class PanelSuratketeranganKurangMampu extends javax.swing.JPanel {

    /** Creates new form suratKeteranganKelakuanBaik */
    public PanelSuratketeranganKurangMampu() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        panelTengah.add(cmbagama, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 210, 290, 30));
        panelTengah.add(txttglsurat, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 410, 290, 30));
        panelTengah.add(txttgllahir, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 170, 290, 30));

        flabel1.setText("Surat Keterangan Kurang Mampu");
        ...
        panelTengah.add(flabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 210, -1, -1));
        ...
        panelTengah.add(txtpekerjaa, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 250, 300, -1));

        flabel8.setText("Pekerjaan :");
        panelTengah.add(flabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, -1, -1));
        ...
        panelTengah.add(flabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 410, -1, -1));
        panelTengah.add(txttujuan, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 450, 300, -1));
        ...
        panelTengah.add(flabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 450, -1, -1));
        panelTengah.add(txtkades1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 370, 300, -1));
    ...
    private void btgenerateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btgenerateActionPerformed
        ...
        suratdomisili sktps = new suratdomisili(getKode(), getNama(), getTempatLahir(), getTanggalSurat(),getAgama(), getPekerjaan(), getAlamat(), getKades(), getTahun(), getTujuan(), getTanggalSurat());
