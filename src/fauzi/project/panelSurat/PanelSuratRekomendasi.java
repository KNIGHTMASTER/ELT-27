...
import fauzi.project.jenisSurat.suratrekomendasi;
 ...
 * @author fauzi
 */
public class PanelSuratRekomendasi extends javax.swing.JPanel {

    /** Creates new form suratKeteranganKelakuanBaik */
    public PanelSuratRekomendasi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        flabel1.setText("Surat Rekomendasi");
    ...
    private void btgenerateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btgenerateActionPerformed
        ...
        suratrekomendasi skm = new suratrekomendasi(getKode(), getNama(), getTempatLahir(), getTanggalLahir(), getPekerjaan(), getAlamat(), getKades(), getTahun(), getTujuan(), getTanggalSurat());
