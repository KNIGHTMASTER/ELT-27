 ...
 * @author dell
 */
public class suratdomisili {
    String kode="", nama="", tempatLahir="", tanggalLahir="", agama="", job="", alamat="", kades="", tahun="", tujuan="";
    String tanggal = "00-00-0000";
    
    public suratdomisili(String kode, String nama, String tempatLahir, String tanggalLahir, String agama, String Job, String alamat, String kades, String tahun, String tujuan, String tanggal){        
        buat();
        this.kode = kode;
        this.nama = nama;
    ...
    public void buat(){
        ...
        myDoc.addEle(Paragraph.withPieces(
                ...
                ParagraphPiece.with("KETERANGAN BERDOMISILI").withStyle().font(Font.TIMES_NEW_ROMAN_BOLD).fontSize("15").underline().create()
        ));
        myDoc.addEle(Paragraph.withPieces(
        ...
        myDoc.addEle(Paragraph.withPieces(
                ParagraphPiece.with("\t").withStyle().font(Font.TIMES_NEW_ROMAN_BOLD).fontSize("12").create(),
                ParagraphPiece.with("Orang tersebut betul - betul Penduduk Desa Toronan Kecamatan Pamekasan Kabupaten Pamekasan dan berdomisili di dusun tersebut").withStyle().font(Font.TIMES_NEW_ROMAN).fontSize("12").create()
        ));               
        //content main
        ...
        myDoc.addEle(Paragraph.withPieces(
                ParagraphPiece.with("\t").withStyle().font(Font.TIMES_NEW_ROMAN_BOLD).fontSize("12").create(),
                ParagraphPiece.with("Demikian surat keterangan ini diberikan kepada yang bersangkutan untuk dipergunakan "+tujuan+" dan dipergunakan sebagaimana mestinya.").withStyle().font(Font.TIMES_NEW_ROMAN).fontSize("12").create()
        ));               
