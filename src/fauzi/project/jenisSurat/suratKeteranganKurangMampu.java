 ...
 * @author ITA
 */
public class suratKeteranganKurangMampu {
String kode="", nama="", tempatLahir="", tanggalLahir="", agama="", job="", alamat="", kades="", tujuan="", tahun="";
String tanggal = "00-00-0000";

    public suratKeteranganKurangMampu(String kode, String nama, String tempatlahir, String tanggallahir, String agama, String job, String alamat, String kades, String tujuan, String tahun, String tanggal){
    this.kode = kode; 
    this.nama = nama;
    ...
    buat();
     ...
     public void buat(){
        ...
        myDoc.addEle(Paragraph.withPieces(
                ...
                ParagraphPiece.with("SURAT KETERANGAN KURANG MAMPU").withStyle().font(Font.TIMES_NEW_ROMAN_BOLD).fontSize("15").underline().create()
        ));
        myDoc.addEle(Paragraph.withPieces(
        ...
        myDoc.addEle(Paragraph.withPieces(
                ParagraphPiece.with("\t").withStyle().font(Font.TIMES_NEW_ROMAN_BOLD).fontSize("12").create(),
                ParagraphPiece.with("Yang tersebut diatas adalah benar-benar Warga Desa Toronan Kecamatan Pamekasan Kabupaten Pamekasan yang termasuk keluarga KURANG MAMPU/EKONOMI LEMAH, dan surat keterangan ini diberikan kepada yang bersangkutan untuk dipergunakan "+tujuan+".").withStyle().font(Font.TIMES_NEW_ROMAN).fontSize("12").create()
        ));
        //content main
